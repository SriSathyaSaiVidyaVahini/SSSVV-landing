...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        if (I.transition) {
            var S = I.timing.dom;
            if (C.style[S] = d["ease-in-back"][0], !C.style[S])
                ...
                function o(t, e, n) {
                    if (t) {
                        ...
                        if ("object" == o) {
                            ...
                            }), f.call(this), c > 0 && (this.timer = new q({
                                duration: c,
                                context: this
    ...
    n(5), n(8), n(9), n(10), n(11), n(12), n(13), n(14), n(15), n(17), n(22), n(23), t.exports = n(24)
}, function(t, e, n) {
    "use strict";
    var i = n(0);
    i.define("brand", t.exports = function(t) {
        ...
        return n.ready = function() {
            ...
            /\.webflow\.io$/i.test(h) && u.hostname !== h && (s = !0), s && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", ""), i = t("<img>").attr("src", "/favicon/favicon-32x32.png").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }), a = t("<img>").attr("src", "/favicon/favicon-32x32.png").attr("alt", "SSSVV team"), n.append(i, a), n[0]), f(), setTimeout(f, 500), t(r).off(l, d).on(l, d))
        }, n
    })
}, function(t, e, n) {
    "use strict";
    ...
    i.define("dropdown", t.exports = function(t, e) {
        ...
        function T(e, r) {
            ...
            n && l.el.on(A, function(t) {
                return function(e, n) {
                    n = n || {}, R(t), !0 === n.open && I(t), !1 === n.open && S(t, {
                        immediate: !0
                    })
                }
                ...
                ! function(e, n) {
                    ...
                    if (d.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), v.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), w) l.on("click", function(t) {
                        ...
                        v.on("click keydown", function(t) {
                            ...
                            (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), a.focus(), m.text(i.name), C() || k(n), n.fileUploads[e].uploading = !0, function(e, n) {
                    ...
                    function _(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = g), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), c.focus(), n.fileUploads[e].uploading = !1, C() || x(n)
                    }
                    ...
                    function O(t) {
                        if (t) return _(t);
                        a.toggle(!1), s.css("display", "inline-block"), s.focus(), n.fileUploads[e].uploading = !1, C() || x(n)
                    }
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function O(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), R(a), s ? (T(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = d.width();
                    R(t), !0 === i.open && F(t, !0), !1 === i.open && $(t, !0), t.open && e.defer(function() {
                        r !== d.width() && I(t)
                    })
                }
            }(a))) : (! function(e) {
        ...
        function F(t, e) {
            if (!t.open) {
                t.open = !0, t.menu.each(W), t.links.addClass(x), t.dropdowns.addClass(g), t.dropdownToggle.addClass(b), t.dropdownList.addClass(y), t.button.addClass(w);
                var n = t.config;
        ...
        function $(t, e) {
            ...
            function u() {
                t.menu.height(""), l(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each(z), t.links.removeClass(x), t.dropdowns.removeClass(g), t.dropdownToggle.removeClass(b), t.dropdownList.removeClass(y), t.overlay && t.overlay.children().length && (E.length ? t.menu.insertAfter(E) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close"), t.button.attr("aria-expanded", "false")
            }
        }
        return c
    })
    ...
    i.define("slider", t.exports = function(t, e) {
        ...
        function k(e, n) {
            ...
            r.el.off(h), r.left.off(h), r.right.off(h), r.nav.off(h), E(r), s ? (r.el.on("setting" + h, I(r)), L(r), r.hasTimer = !1) : (r.el.on("swipe" + h, I(r)), r.left.on("click" + h, C(r)), r.right.on("click" + h, T(r)), r.left.on("keydown" + h, O(r, C)), r.right.on("keydown" + h, O(r, T)), r.nav.on("keydown" + h, "> div", I(r)), r.config.autoplay && !r.hasTimer && (r.hasTimer = !0, r.timerCount = 1, R(r)), r.el.on("mouseenter" + h, A(r, !0, "mouse")), r.el.on("focusin" + h, A(r, !0, "keyboard")), r.el.on("mouseleave" + h, A(r, !1, "mouse")), r.el.on("focusout" + h, A(r, !1, "keyboard"))), r.nav.on("click" + h, "> div", I(r)), f || r.mask.contents().filter(function() {
        ...
        function A(e, n, i) {
            return function(r) {
                ...
                n ? (e.ariaLiveLabel.attr("aria-live", "polite"), e.hasTimer && L(e)) : (e.ariaLiveLabel.attr("aria-live", "off"), e.hasTimer && R(e))
            }
        }
            ...
            return function(r, a) {
                ...
                if (s && "setting" === r.type) {
                    ...
                    if ("swipe" === r.type) {
                        ...
                        return "left" === a.direction ? T(n)() : "right" === a.direction ? C(n)() : void 0
                    }
        ...
        function D(e, n) {
            ...
            var d = e.offsetX || 0,
                ...
                E = "opacity " + x + "ms " + y,
                _ = "transform " + x + "ms " + y;
            if (p.find(a).removeAttr("tabindex"), p.removeAttr("aria-hidden"), p.find("*").removeAttr("aria-hidden"), m.find(a).attr("tabindex", "-1"), m.attr("aria-hidden", "true"), m.find("*").attr("aria-hidden", "true"), s || (p.each(w.intro), m.each(w.outro)), n.immediate && !g) return l(p).set(h), void C();
    ...
    i.define("tabs", t.exports = function(t) {
        ...
        function g() {
            n = l && i.env("design"), (e = s.find(h)).length && (e.each(x), i.env("preview") && !w && e.each(y), b(), i.redraw.on(o.redraw))
        }
        ...
        function x(e, i) {
            ...
            if (a || (a = t.data(i, h, {
                    el: o,
                    config: {}
                })), a.current = null, a.tabIdentifier = r + "-" + d, a.paneIdentifier = r + "-" + f, a.menu = o.children(".w-tab-menu"), a.links = a.menu.children(".w-tab-link"), a.content = o.children(".w-tab-content"), a.panes = a.content.children(".w-tab-pane"), a.el.off(h), a.links.off(h), a.menu.attr("role", "tablist"), a.links.attr("tabindex", "-1"), function(t) {
                    var e = {};
        ...
        function k(e, n) {
            ...
            if (s !== e.current) {
                ...
                e.current = s, e.links.each(function(i, o) {
                    ...
                    o.getAttribute(d) === s ? (u = o, a.addClass(p).removeAttr("tabindex").attr({
                        "aria-selected": "true"
                ...
                var b = window.scrollX,
                    y = window.scrollY;
                u.focus(), window.scrollTo(b, y), g.length && r.outro ? (g.each(m.outro), a(g).add("opacity " + r.outro + "ms " + o, {
                    fallback: c
                }).start({
                    opacity: 0
                }).then(function() {
